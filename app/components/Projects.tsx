            ...
            >
              <div>
                ...
                <div className="flex items-center justify-between gap-4 mb-5">
                  <span className={`px-2.5 py-1 rounded-md text-[10px] font-mono border uppercase tracking-wider ${getBadgeStyle(project.glowColor)}`}>
                    {project.category}
                  </span>
                  ...
                  {project.metrics && (
                    <div className="flex items-center gap-1.5 font-mono text-[10px] text-slate-400">
                      ...
                      <span className="text-white font-semibold">{project.metrics.value}</span>
                    </div>
                  )}
                </div>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-4 mt-2">
                <span className={`px-2.5 py-1 rounded-md text-[10px] font-mono border uppercase tracking-wider ${getBadgeStyle(selectedProject.glowColor)}`}>
                ...
                {selectedProject.metrics && (
                  <div className="flex items-center gap-1 font-mono text-[10px] text-slate-400 bg-white/3 border border-white/5 py-1 px-2.5 rounded-md">
                    <span className="text-slate-500">{selectedProject.metrics.label}:</span>
                    <span className="text-white font-medium">{selectedProject.metrics.value}</span>
                  </div>
                )}
              </div>
